            ...
            <form action="" method="post" onsubmit="return validatePhoneNumber()">
                ...
                <div class="input">
                    ...
                    <div class="image-radio-group">
                        <input type="radio" id="books" name="image-choice" value="Books" required>
                        <label for="books">
                            <img src="img/form/1.png" alt="Books">
                        </label>
                        <input type="radio" id="school-uniforms" name="image-choice" value="School Uniforms" checked>
                        <label for="school-uniforms">
                            <img src="img/form/2.png" alt="School Uniforms">
                        </label>
                        <input type="radio" id="educational-toys" name="image-choice" value="Educational Toys">
                        <label for="educational-toys">
